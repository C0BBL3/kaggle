...
sex_training_dataframe = training_dataframe.select_columns(['Survived', 'Sex', 'constant'])
sex_ratings = [[survived] for survived in sex_training_dataframe['Survived']]
sex_training_dataframe.remove_columns('Survived')
sex_training_x = np.array(sex_training_dataframe.to_array())
sex_training_y = np.array(sex_ratings)
sex_coeffs = LinearRegression().fit(sex_training_x, sex_training_y)
print(sex_coeffs.score(sex_training_x, sex_training_y))

sex_pclass_training_dataframe = training_dataframe.select_columns(['Survived', 'Sex', 'Pclass', 'constant'])
sex_pclass_ratings = [[survived] for survived in sex_pclass_training_dataframe['Survived']]
sex_pclass_training_dataframe.remove_columns('Survived')
sex_pclass_training_x = np.array(sex_pclass_training_dataframe.to_array())
sex_pclass_training_y = np.array(sex_pclass_ratings)
sex_pclass_coeffs = LinearRegression().fit(sex_pclass_training_x, sex_pclass_training_y)
print(sex_pclass_coeffs.score(sex_training_x, sex_training_y))

sex_pclass_dot_dot_dot_training_dataframe = training_dataframe.select_columns(['Survived', 'Sex', 'Pclass', 'Fare', 'Age', 'SibSp', 'SibSp=0', 'Parch=0', 'constant'])
sex_pclass_dot_dot_dot_ratings = [[survived] for survived in sex_pclass_dot_dot_dot_training_dataframe['Survived']]
sex_pclass_dot_dot_dot_training_dataframe.remove_columns('Survived')
sex_pclass_dot_dot_dot_training_x = np.array(sex_pclass_dot_dot_dot_training_dataframe.to_array())
sex_pclass_dot_dot_dot_training_y = np.array(sex_pclass_dot_dot_dot_ratings)
sex_pclass_dot_dot_dot_coeffs = LinearRegression().fit(sex_pclass_dot_dot_dot_training_x, sex_pclass_dot_dot_dot_training_y)
print(sex_pclass_dot_dot_dot_coeffs.score(sex_training_x, sex_training_y))
